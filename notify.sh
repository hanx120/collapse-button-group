...
git remote add github https://$GITHUB_TOKEN@github.com/hanxx/collapse-button-group.git > /dev/null 2>&1
git push github HEAD:master --follow-tags

GREN_GITHUB_TOKEN=$GITHUB_TOKEN yarn release

url=https://api.github.com/repos/hanxx/collapse-button-group/releases/latest
...
msg='{"msgtype": "markdown", "markdown": {"title": "collapse-button-group更新", "text": "@所有人\n# [collapse-button-group('$version')]('$html_url')\n'$body'"}}'
